...
namespace PRUEBA1.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("pkclientes,nombre,apellido,cedula")] Clientes clientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("pkclientes,nombre,apellido,cedula")] Clientes clientes)
        {
